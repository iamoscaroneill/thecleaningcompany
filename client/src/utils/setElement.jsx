const setElement = (link, i, menu, showMenu, serviceRef, priceRef) => {
    switch (true) {
        ...
        case link.type === 'Schedule Now': return (<a key={i} id="schedule_element" className={menu.links} href={link?.link} onClick={showMenu} target='_blank' rel="noreferrer">{link?.type} &nbsp; <i className="fa-regular fa-clock"></i></a>);
    }
}
